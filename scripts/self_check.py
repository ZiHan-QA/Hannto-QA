...
def main() -> None:
    ...
    require(html, [
        ...
        "function taskHasTestHubPlans",
        "function canCurrentUserManuallyUpdateTaskStatus",
        "TestHub 事项状态由同步结果自动更新",
    ...
    require(tasks_js, [
        ...
        "const includesTestHubTask",
        "taskBatchStatusControls",
        "function taskDetailDrawerHtml",
        "function taskStatusBadgeHtml",
        "function renderTaskRowHtml",
        "row.canUpdateStatus && !row.testHubPlanCount",
